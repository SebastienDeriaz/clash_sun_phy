...
nextState C 1 _ _ _ 1 = A -- to A if the slave did write and d_last_i is 1
nextState x _ _ _ _ _ = x


mux4 :: State -> Bit -> Bit -> Bit -> Bit -> Bit
...
concat4
    ...
    -> Signal dom Bit -- d_data_i
    -> Signal dom Bit -- d_last_i
    -> Signal dom Bit -- ready_i
    -> Signal dom (Bit, Bit, Bit, Bit, Bit, Bit, Bit) -- a_ready_o, b_ready_o, c_ready_o, d_ready_o, valid, data, last
concat4 a_valid_i a_data_i a_last_i b_valid_i b_data_i b_last_i c_valid_i c_data_i c_last_i d_valid_i d_data_i d_last_i ready_i = bundle (a_ready_o, b_ready_o, c_ready_o, d_ready_o, valid_o, data_o, last_o)
  where
